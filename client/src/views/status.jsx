...
export default React.createClass({
  render() {
    const serverTime = this.props.time ? (new Date(this.props.time)).toString() : '';
    return (
      <div>
        <div className='status_container'>
          <div className='status_label'>Server Time:</div>
          <div className='status_value'>{serverTime}</div>
        </div>
        <div className='status_container'>
          <div className='status_label'>Lighting State:</div>
          <div className='status_value'>{this.props.lightingState}</div>
        </div>
        <div className='status_container'>
          <div className='status_label'>Next Transition At:</div>
          <div className='status_value'>{this.props.nextTransitionTime}</div>
        </div>
        <div className='status_container'>
